...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class KspSymbolLibraryAccessors extends SubDependencyFactory {
        private final KspSymbolProcessingLibraryAccessors laccForKspSymbolProcessingLibraryAccessors = new KspSymbolProcessingLibraryAccessors(owner);

        public KspSymbolLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>ksp.symbol.processing</b>
         */
        public KspSymbolProcessingLibraryAccessors getProcessing() {
            return laccForKspSymbolProcessingLibraryAccessors;
        }

    }

    public static class KspSymbolProcessingLibraryAccessors extends SubDependencyFactory {

        public KspSymbolProcessingLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        public Provider<MinimalExternalModuleDependency> getApi() {
            return create("ksp.symbol.processing.api");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>ksp</b> with value <b>1.8.10-1.0.8</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
